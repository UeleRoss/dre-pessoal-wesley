...
BEGIN
  IF EXISTS (
    ...
    WHERE table_schema = 'public' AND table_name = 'credit_cards' AND column_name = 'card_type'
  ) THEN
  ...
  IF EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'financial_items' AND column_name = 'purchase_date'
  ) THEN
...
-- =====================================================
-- PRONTO! Agora teste criar/editar cartões
-- =====================================================
