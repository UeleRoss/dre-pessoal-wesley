...
// Categorias padrão específicas para investimentos
...
const InvestmentCategoryManager = () => {
  ...
  // Mutation para remover categoria de investimento
  const deleteCategoryMutation = useMutation({
    mutationFn: async (category: InvestmentCategory) => {
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: "Categoria de investimento removida com sucesso!",
      });
    },
    onError: (error: any) => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Gerenciar Categorias de Investimento</CardTitle>
      </CardHeader>
...
export default InvestmentCategoryManager;
